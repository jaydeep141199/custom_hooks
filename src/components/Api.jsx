        ...
        <div className="text-center bg-gray-400">
          <div className="grid grid-cols-4 gap-4 p-5">
            {product.map((item) => (
              ...
              >
                {/* <img
                  className="h-[150px] py-[10px] mx-[75px] w-[150px] transition duration-700 ease-in-out hover:scale-125"
                  src={item.image}
                  alt={item.title}
                /> */}
                <div className="py-4">
                ...
                {/* add to cart */}
                {/* <div>
                  <button className="bg-yellow-500 px-10 py-2 my-2 outline-none border rounded-full font-bold">
                    Add To Cart
                  </button>
